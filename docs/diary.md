...
- **ADR-0019 clarification:** pglite is the *real* Postgres engine run as a fast lower tier, not a mock — the infrastructure-first e2e-against-Neon tier is unchanged. Not a new ADR (easily reversible); recorded here per the running-log convention (ADR-0019 itself is inline in `docs/spec.html`).
