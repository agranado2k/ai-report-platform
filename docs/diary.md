...
| **Active worktrees**   | `worktree/idempotency-state-setting` (branch `fix/idempotency-state-setting`) — #233, this entry. `worktree/unlock-page-and-editability` (PR #256, green, awaiting merge). Everything from the #230–#255 arc is merged and pruned. |
