...
- **Slug** — the permanent, URL-safe `nanoid(10)` identifier for a `Report`. Globally unique across the platform. Cannot change after creation. Value Object. Spec: ADR-001.
