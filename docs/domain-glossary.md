...
- **ReportPage** — one page of `ReportSummary`s plus the `total` matching the query (so the UI can show "page X of Y"). The result type of the `searchReports` use case. An application read type. Spec: ADR-0036.
