...
| 0070 | [Audit log write seam — the `AuditLogger` port, mirroring the transactional outbox](0070-audit-log-write-seam.md) | Accepted (2026-07-09) — mirrors ADR-0021's outbox shape; wires uploadReport + deleteReport as the pattern proof (issue #153) |
