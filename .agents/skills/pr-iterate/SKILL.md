...
- **`/review-and-evaluate`** (`.agents/skills/review-and-evaluate/SKILL.md`) — the local review step inserted at iteration step 2.
- **`/review-pr`** (`.agents/skills/review-pr/SKILL.md`) — used internally by `/review-and-evaluate` for the 6-sub-agent review.
