...
- **PR-only delivery** with signed commits + linear history. Human approval is currently 0 (solo-developer branch-protection policy); AI review (Claude) + CI status checks are the gates.
