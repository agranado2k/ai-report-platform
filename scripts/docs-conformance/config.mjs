...
export const features = {
  ...
  'upload-report-via-api': { title: 'Upload a report via the HTTP API', phase: '@phase-1', status: 'full' },
  're-upload-keeps-url-stable': { title: 'Re-upload keeps the slug stable', phase: '@phase-1', status: 'full' },
  'upload-report-via-web': { title: 'Upload a report from the web UI', phase: '@phase-1', status: 'full' },
  'view-published-report': { title: 'View a published report', phase: '@phase-1', status: 'full' },
  'view-report-while-scanning': { title: 'View a report that is still scanning', phase: '@phase-1', status: 'full' },
  'view-version-by-ordinal': { title: 'View a specific version with ?v=N', phase: '@phase-1', status: 'full' },
  ...
  'enforce-plan-limits': { title: 'Enforce plan limits on upload', phase: '@phase-1', status: 'full' },
  'enforce-api-key-scopes': { title: 'Enforce API key scopes', phase: '@phase-1', status: 'full' },
  'viewer-origin-isolation': { title: 'Viewer origin isolation', phase: '@phase-1', status: 'full' },
  'block-service-worker': { title: 'Block service-worker registration', phase: '@phase-1', status: 'full' },
  'viewer-security-headers': { title: 'Viewer security-header stack', phase: '@phase-1', status: 'full' },
  'problem-json-error-model': { title: 'RFC 9457 problem+json error model', phase: '@phase-1', status: 'full' },
  'sign-up-and-switch-orgs': { title: 'Sign up and switch organizations', phase: '@phase-1', status: 'full' },
  'audit-log-every-action': { title: 'Audit-log every mutating action', phase: '@phase-1', status: 'full' },
  // ── Phase 1.5: scanning + abuse ──────────────────────────────────────
  'report-flagged-unavailable': { title: 'Flagged report is unavailable (451)', phase: '@phase-1.5', status: 'wip' },
  'report-taken-down': { title: 'Taken-down report is gone (410)', phase: '@phase-1.5', status: 'wip' },
  ...
  'organize-reports-in-folders': { title: 'Organize reports in folders', phase: '@phase-2', status: 'wip' },
  'cross-org-collaboration': { title: 'Cross-org collaboration via grants', phase: '@phase-2.5', status: 'wip' },
  ...
  'detect-api-key-anomaly': { title: 'Detect API-key usage anomalies', phase: '@phase-4', status: 'wip' },
  'trusted-types-dashboard': { title: 'Trusted Types on the dashboard', phase: '@phase-1', status: 'wip' },
};
...
export const openapi = {
  mustContain: [
    ...
    "'201'", "'401'", "'402'", "'403'", "'404'",
    "'409'", "'413'", "'415'", "'422'", "'429'", "'500'",
    // Stable machine-readable `code` registry (ADR-0040).
    'unauthenticated', 'forbidden', 'not_found', 'unsupported_media_type',
    'payload_too_large', 'validation_error', 'idempotency_key_reuse',
    'idempotency_in_flight', 'plan_limit_exceeded', 'rate_limited', 'internal_error',
  ],
  hints: {
